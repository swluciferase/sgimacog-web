...
const EegReportTemplate: React.FC<ReportProps> = ({
  subjectInfo, brainIndices, capabilityProfile, summary, topSupps, topFlowers, rppg,
}) => {
        ...
        <div className="bg-white shadow-lg print:shadow-none w-full min-h-[296mm] p-[20mm] flex flex-col break-after-page page-break">
          ...
          <div className="flex justify-between items-start border-b-2 border-indigo-900 pb-6 mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-black text-3xl tracking-tighter text-indigo-900 block leading-none">SIGMACOG</span>
                <span className="text-[10px] uppercase tracking-[0.2em] text-indigo-500 font-bold">Brain Health Guide</span>
              </div>
            </div>
...
<head>
  ...
  <title>腦健康評估報告 — ${props.subjectInfo.id}</title>
...
<script>
  ...
  // Revoke after the new window has time to load
