...
// api/font.js
async function handleFontRequest2(context) {
  const req = context.request;
  let text = "";
  if (req.method === "POST") {
    text = await req.text();
...
__name(handleFontRequest2, "handleFontRequest");
async function onRequestGet2(context) {
  return handleFontRequest2(context);
}
...
// ../.wrangler/tmp/pages-QHURwr/functionsRoutes-0.029970706292081317.mjs
var routes = [
  {
...
// ../../../../../private/var/folders/ry/5hlspsj12slc2_k2vxg4t4_40000gn/T/bunx-501-wrangler@latest/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../private/var/folders/ry/5hlspsj12slc2_k2vxg4t4_40000gn/T/bunx-501-wrangler@latest/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
